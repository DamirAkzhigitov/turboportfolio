  ...
  const workHistory = [
    {
      ...
      end_date: 'Present',
      description: [
        'Worked on architecture and development of micro-frontend modules, driving improvements across the frontend chapter. Contributed to shared tooling, frontend standards, and CI/CD processes.\n\nLed the migration from Vue 2 to Vue 3, refactoring core libraries for better performance and maintainability. Proposed and implemented practical solutions to improve code quality, developer experience, and team workflows.',
      ],
    },
    {
      title: 'Senior Frontend Engineer',
      company: 'MUFG Investor Services FinTech',
      location: 'Limassol, Cyprus',
      start_date: '2022-03',
      end_date: '2023-01',
      description: [
        'Built micro-frontend modules using DDD and TDD principles. Worked extensively with TypeScript, GraphQL, Apollo, REST APIs, and modern tooling such as Vite. Used Playwright for end-to-end testing and Jest for unit tests.\n\nSet up CI/CD pipelines and integrated with AWS services to support automation and scalability across teams.',
    ...
    },
    {
      ...
      end_date: '2020-12',
      description: [
        'Led frontend development using modular ES6 JavaScript with a focus on performance and low-level DOM manipulation.\n\nBuilt custom A/B testing components to help e-commerce clients improve conversion rates based on experiment data.',
